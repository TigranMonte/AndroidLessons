...
public class PrefActivity extends PreferenceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chb1.setKey("chb2");
        chb1.setTitle("CheckBox 2");
        chb1.setSummary("Description of checkbox 2");
        ...
        chb4.setKey("chb5");
        chb4.setTitle("CheckBox 5");
        chb4.setSummary("Description of checkbox 5");

        categ1.addPreference(chb5);

        CheckBoxPreference chb6 = new CheckBoxPreference(this);
        chb4.setKey("chb6");
        chb4.setTitle("CheckBox 6");
        chb4.setSummary("Description of checkbox 6");

        categ1.addPreference(chb6);
